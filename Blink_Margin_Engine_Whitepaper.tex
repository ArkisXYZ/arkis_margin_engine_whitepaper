...
For concentrated liquidity, price ranges may significantly impact updated token quantities under a stress-test scenario. As a result, Uniswap V3 LP positions are exposed to a bigger gamma risk than V2. TODO: add math.
