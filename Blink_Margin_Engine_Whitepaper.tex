...
1INCH SDK provides a user with $getQuote$ function which calculates the estimated price impact of a trade based on the current state of the 1INCH DEX aggregator.
