...
Where \textbf{$\text{futures\_exposure}_{t}^{i}$} is the signed (long/short) futures position value denominated in borrowed asset. We use futures Mark Price to get USDT exposure and Oracle price of USDT to borrowed asset to estimate final exposure. price  
